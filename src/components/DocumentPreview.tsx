...
import { compileAndProcessMarkdown, postProcessCompiledMarkdown, BASE_TOC_CSS } from '../utils/markdownCompiler';
import { FileText, Layers, RefreshCw, ZoomIn, ZoomOut, Copy, Check, ExternalLink } from 'lucide-react';
...
export const toolbarHTML_Preview = `<!-- Floating Academic Toolbar (Omitted when printing) -->
...
<body>
  ...
  const resolvedHtmlContent = React.useMemo(() => {
    ...
    return postProcessCompiledMarkdown(selectHtml, {
      uploadedFiles,
      bibliography,
      settings,
